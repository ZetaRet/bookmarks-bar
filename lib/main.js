...
function createFolderModal(fbtn) {
	...
	if (fnel) {
		...
		fnel.addEventListener('click', function(e) {
			...
			p.innerHTML = "<input class='f-inp' type='text'/><br/>" +
				"<input class='c-inp' type='text'/><br/>" +
			...
			input.setAttribute('title', 'Press `Enter` to save folder');
			cinput.setAttribute('title', 'Press `Enter` to save folder');
