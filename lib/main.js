...
function createStarModal() {
	...
	sel += '</select>';
	var newfolder =
		'Create new folder: <input class="folder-input zetaretbookmarksbarinput" type="text" style="width:100%; color:#000; backgorund-color:#fff; border:none; padding:2px; display:block;"/>';
